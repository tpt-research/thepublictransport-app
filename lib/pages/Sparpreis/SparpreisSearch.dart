...
class _SparpreisSearchState extends State<SparpreisSearch> {
            ...
            Center(
              child: Container(
                child: GradientCard(
                  ...
                  shadowColor: PredefinedColors.getDBGradient().colors.last.withOpacity(0.25),
                  elevation: 8,
  ...
  List<String> showSuggestions() {
    return [
      ...
      "Früh morgens und spät abends sind am günstigsten.",
      "Die Umstiege können den Preis beeinflussen.",
      "Je nach Fahrt können entweder Regionalverkehr oder Fernverkehr günstiger sein."
    ];
  }
