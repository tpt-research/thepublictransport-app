...
class FFFSearchTrip extends StatefulWidget {
  const FFFSearchTrip({Key key, this.new_search, this.new_search2}) : super(key: key);

  final SuggestedLocation new_search;
  final SuggestedLocation new_search2;

  @override
  _FFFSearchTripState createState() => _FFFSearchTripState(new_search, new_search2);
}

class _FFFSearchTripState extends State<FFFSearchTrip> {
  ...
  _FFFSearchTripState(this.new_search, this.new_search2);
  ...
  void initState() {
    ...
    pc = PanelController();
    if (new_search != null) {
      from_search = new_search;
      _typeAheadControllerStart.text = new_search.location.name + (new_search.location.place != null ? ", " + new_search.location.place : "");
    }
    if (new_search2 != null) {
      to_search = new_search2;
      _typeAheadControllerEnd.text = new_search2.location.name + (new_search2.location.place != null ? ", " + new_search2.location.place : "");
    }
    super.initState();
  }
