...
class NearbyTimelinePage extends StatefulWidget {
  NearbyTimelinePage(this.id, this.name);

  final String id;
  final String name;

  @override
  _NearbyTimelinePage createState() => _NearbyTimelinePage(this.id, this.name);
}

class _NearbyTimelinePage extends State<NearbyTimelinePage> {
  _NearbyTimelinePage(this.id, this.name);
