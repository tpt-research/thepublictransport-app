...
import 'package:thepublictransport_app/pages/nearby/nearby_timeline.dart';
...
class _TimelinePage extends State<TimelinePage> {
  ...
  Future<List<TimelineModel>> getTimeline() async {
    List<RMVJourneysModel> models =
        await RMVJourneysRequest.getJourneys(this.journeyID);
    ...
    for (var i in models) {
      var object = TimelineModel(
              ...
              child: InkWell(
                onTap: () {
                  Navigator.of(context).push(MaterialPageRoute(
                      builder: (context) =>
                          NearbyTimelinePage(i.extID, i.name)));
                },
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: <Widget>[
                      ListTile(
                        title: new Text("Haltestelle".toUpperCase(),
                            style: new TextStyle(
                      ...
                      ListTile(
                        title: new Text("Ankunft".toUpperCase(),
                            style: new TextStyle(
                                ...
                                color: ColorThemeEngine.titleColor)),
                        subtitle: new GradientText(
                          i.time.hour.toString().padLeft(2, '0') +
                              ":" +
                              i.time.minute.toString().padLeft(2, '0'),
                          style: new TextStyle(
                              fontWeight: FontWeight.w500,
                              fontSize: 25,
                              color: Colors.grey),
          ...
          icon:
              Icon(Icons.location_on, color: ColorThemeEngine.backgroundColor));
      timeline.add(object);
    }
  ...
  Widget build(BuildContext context) {
    return new TPTScaffold(
      ...
      body: Container(
        ...
        child: new FutureBuilder<List<TimelineModel>>(
          future: getTimeline(),
            ...
            switch (snapshot.connectionState) {
              ...
              case ConnectionState.done:
                ...
                return SizedBox(
                  ...
                  child: Timeline(
                      children: snapshot.data, position: TimelinePosition.Left),
                );
            }
