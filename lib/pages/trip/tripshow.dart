...
class _TripShowPageState extends State<TripShowPage> {
    ...
    return TPTScaffold(
      ...
      body: Container(
        ...
        child: ListView(
          ...
          children: <Widget>[
            ListTile(
              title: new Text("Haltestelle in der Nähe".toUpperCase(),
                  style: new TextStyle(
            ...
            Padding(padding: EdgeInsets.only(top: 15)),
            ListTile(
              title: new Text("Endhaltestelle".toUpperCase(),
                  style: new TextStyle(
                      fontWeight: FontWeight.w500,
                      fontSize: 13,
                      color: ColorThemeEngine.titleColor)),
            ...
            Padding(padding: EdgeInsets.only(top: 15)),
            ListTile(
              title: new Text("Geplante Ankunft".toUpperCase(),
                  style: new TextStyle(
                      fontWeight: FontWeight.w500,
                      fontSize: 13,
                      color: ColorThemeEngine.titleColor)),
              subtitle: new GradientText(
                model.time.hour.toString().padLeft(2, '0') +
                    ":" +
                    model.time.minute.toString().padLeft(2, '0'),
                style: new TextStyle(
                    fontWeight: FontWeight.w500,
                    fontSize: 25,
                    color: Colors.grey),
            ...
            Padding(padding: EdgeInsets.only(top: 15)),
            ListTile(
              title: new Text("Zurzeitige Ankunft".toUpperCase(),
                  style: new TextStyle(
                      fontWeight: FontWeight.w500,
                      fontSize: 13,
                      color: ColorThemeEngine.titleColor)),
              subtitle: new GradientText(
                model.realtime.hour.toString().padLeft(2, '0') +
                    ":" +
                    model.realtime.minute.toString().padLeft(2, '0'),
                style: new TextStyle(
                    fontWeight: FontWeight.w500,
                    fontSize: 25,
                    color: Colors.grey),
            ...
            Padding(padding: EdgeInsets.only(top: 15)),
            ListTile(
                title: new Text("Typ".toUpperCase(),
                    style: new TextStyle(
                        fontWeight: FontWeight.w500,
                        fontSize: 13,
                        color: ColorThemeEngine.titleColor)),
  ...
  Widget chooseDelay(DateTime time, DateTime realtime) {
    ...
    if (compare.inMinutes >= 5)
      return ListTile(
        title: new Text("Verspätung".toUpperCase(),
            style: new TextStyle(
                fontWeight: FontWeight.w500,
                fontSize: 13,
                color: ColorThemeEngine.titleColor)),
        subtitle: new GradientText(
          "Dieses Verkehrsmittel hat " +
              compare.inMinutes.toString() +
              " Minuten Verspätung. Weichen Sie lieber auf eine Alternative aus.",
          style: new TextStyle(
