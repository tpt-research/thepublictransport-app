...
class LastPublicLeg {
  ...
  factory LastPublicLeg.fromRawJson(String str) => LastPublicLeg.fromJson(json.decode(str));

  String toRawJson() => json.encode(toJson());

  factory LastPublicLeg.fromJson(Map<String, dynamic> json) => new LastPublicLeg(
